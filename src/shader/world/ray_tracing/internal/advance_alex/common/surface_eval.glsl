...
#ifndef ADVANCE_ALEX_SURFACE_RAIN_GRADIENT
#    define ADVANCE_ALEX_SURFACE_RAIN_GRADIENT 0.0
#endif
...
void sampleSurfaceState(bool useTexture,
    ...
    alexApplyRainMaterial(packedData, ADVANCE_ALEX_SURFACE_RAIN_GRADIENT, worldPos, uv, textureID, mat, albedoValue);
