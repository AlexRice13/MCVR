...
class ScenarioColorGradingManager : public Singleton<ScenarioColorGradingManager> {
  ...
  public:
    ...
    ScenarioResolvedState resolveState(const ToneMappingSettings &baseSettings, bool hdrActive);
    ToneMappingSettings resolveSettings(const ToneMappingSettings &baseSettings, bool hdrActive);
    std::vector<std::string> exportResolvedAttributePairs(const ToneMappingSettings &baseSettings,
                                                          bool hdrActive,
  ...
  private:
    ...
    ScenarioResolvedState resolveStateLocked(const ToneMappingSettings &baseSettings, bool hdrActive);
